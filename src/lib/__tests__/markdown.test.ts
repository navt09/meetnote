...
const notes: MeetingNotes = {
  ...
  action_items: [
    { title: "Fix mobile search crash", details: "Crashes on Safari.", owner: "Marcus", due: "Thursday", priority: "high", kind: "bug", quote: "it crashes on Safari every time", first_step: "Reproduce it on Safari.", blocked_by: null },
    { title: "Email Priya", details: "", owner: null, due: null, priority: "medium", kind: "follow_up", quote: null, first_step: null, blocked_by: null },
  ],
