...
const MARKS: Record<Provider, Mark> = {
  ...
  microsoft: {
    hex: "#5E5E5E",
    label: "Microsoft",
    // The four-square mark, written out rather than imported: it is four
    // rectangles, and the real logo's colours would be the only thing a
    // licensed copy added, which this drawing does not use anyway.
